...
def invalidate_user_cache_on_bought_film_change(sender: Film, instance: GeneralUser, action, pk_set, **kwargs):
...
def invalidate_user_cache_on_wishlist_film_change(sender: Film, instance: GeneralUser, action, pk_set, **kwargs):
